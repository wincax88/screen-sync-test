    ...
    */
    ...
    var CanvasRenderer = /** @class */ (function () {
        ...
        CanvasRenderer.prototype.renderTextNode = function (text, styles) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, font, fontFamily, fontSize, _b, baseline, middle;
                var _this = this;
        ...
        CanvasRenderer.prototype.renderNodeContent = function (paint) {
            return __awaiter(this, void 0, void 0, function () {
                var container, curves, styles, _i, _a, child, image, image, iframeRenderer, canvas, size, _b, fontFamily, fontSize, baseline, bounds, x, textBounds, img, image, url, _c, fontFamily, fontSize, bounds, baseline;
                    ...
                    switch (_d.label) {
                        ...
                        case 19:
                            if (paint.listValue && container.styles.listStyleType !== LIST_STYLE_TYPE.NONE) {
                                _c = this.createFontStyle(styles), fontFamily = _c[0], fontSize = _c[1];
                                this.ctx.font = fontFamily;
                                this.ctx.fillStyle = asString(styles.color);
                                this.ctx.textBaseline = 'middle';
                                ...
                                baseline = this.fontMetrics.getMetrics(fontFamily, fontSize).baseline;
                                this.renderTextWithLetterSpacing(new TextBounds(paint.listValue, bounds), styles.letterSpacing, baseline);
                                this.ctx.textBaseline = 'bottom';
                                this.ctx.textAlign = 'left';
                            }
                            _d.label = 20;
